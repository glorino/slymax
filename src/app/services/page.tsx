  ...
  return (
    <>
              ...
              >
                <Link href={service.href}>
                  <Card className={`group h-full overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 border-0 ${service.bgColor}`}>
                    <div className="p-6">
                      <div className={`flex h-14 w-14 items-center justify-center rounded-xl ${service.iconBg} shadow-md group-hover:shadow-lg transition-shadow mb-4`}>
                      ...
                      <Button variant="ghost" className="w-full justify-between px-0 group-hover:text-orange-600" asChild>
                        <Link href={service.href}>
                          Learn More
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-50 relative overflow-hidden" aria-labelledby="why-heading">
        ...
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-cyan-200 rounded-full -translate-x-1/4 translate-y-1/4 opacity-20" aria-hidden="true" />
        <Container>
      ...
      {/* CTA */}
      <section className="py-20 lg:py-32 bg-gradient-to-r from-orange-500 via-red-500 to-pink-600 relative overflow-hidden">
