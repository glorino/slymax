...
const services = [
  ...
  },
  {
    ...
    features: ["Gas Equipment Supply", "Pipeline Services", "Oil & Gas Support", "Gas Regulation Stations", "SCADA Integration", "Safety Systems"],
                ...
                <Link href={service.href}>
                  <Card className={`group h-full overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 border-0 ${service.bgColor}`}>
                    ...
                    <CardContent className="p-6">
                      ...
                      <Button variant="ghost" className="w-full justify-start px-0 group-hover:text-orange-600" asChild>
                        <Link href={service.href}>
                          Learn More
