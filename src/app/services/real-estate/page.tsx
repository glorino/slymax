...
export default function RealEstatePage() {
  return (
    <>
      <section className="relative min-h-[50vh] flex items-center justify-center bg-gradient-to-b from-emerald-100 via-emerald-50 to-white overflow-hidden">
        <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] bg-center opacity-5" aria-hidden="true" />
        <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-300 rounded-full translate-x-1/3 -translate-y-1/3 opacity-20" aria-hidden="true" />
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-white via-emerald-50/30 to-white" aria-labelledby="services-heading">
        <Container>
