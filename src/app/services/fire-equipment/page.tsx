...
import { ArrowRight, CheckCircle, ChevronRight, Flame, Shield, Truck, Bell } from "lucide-react"
...
const fireServices = [
  {
    ...
    icon: Flame,
    features: ["ABC Extinguishers", "CO2 Extinguishers", "Foam Extinguishers", "Wet Chemical", "Automatic Systems", "Portable Units"],
  },
  {
    title: "Alarm Systems",
    description: "Advanced fire detection and alarm systems for early warning and emergency response.",
    icon: Bell,
    features: ["Smoke Detectors", "Heat Detectors", "Manual Call Points", "Sounders & Beacons", "Control Panels", "Integration Systems"],
  },
  {
    title: "Safety Training",
    description: "Professional fire safety training for employees and emergency response teams.",
    icon: Shield,
    features: ["Fire Warden Training", "Evacuation Drills", "First Aid Training", "Fire Safety Awareness", "Practical Exercises", "Certification"],
  },
  {
    title: "Maintenance Services",
    description: "Regular maintenance, inspection, and servicing of all fire safety equipment.",
    icon: Truck,
    features: ["Annual Inspections", "Equipment Servicing", "Refill Services", "System Testing", "Compliance Audits", "Emergency Support"],
  },
]

const projectHighlights = [
  {
    title: "Office Complex Fire Protection",
    category: "Commercial",
    location: "Lagos State",
    year: "2024",
    description: "Complete fire protection system installation for a 15-story office complex.",
  },
  {
    title: "Industrial Factory Safety Upgrade",
    category: "Industrial",
    location: "Rivers State",
    year: "2023",
    description: "Fire detection and suppression system upgrade for a manufacturing plant.",
  },
  {
    title: "Hotel Chain Fire Compliance",
    category: "Hospitality",
    location: "Edo State",
    year: "2024",
    description: "Fire safety equipment supply and training for a chain of 10 hotels.",
  },
]
...
export default function FireEquipmentPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                Complete
                <br />
                <span className="text-orange-600">Fire Safety Solutions</span>
              </h1>
              <p className="text-lg sm:text-xl text-gray-600 leading-relaxed mb-8 max-w-xl">
                Fire extinguishers, alarm systems, safety training, and maintenance services. 
                Protecting lives and property with reliable fire safety solutions.
              </p>
            ...
            >
              <div className="bg-white p-6 rounded-2xl border border-orange-100 text-center shadow-sm">
                <div className="text-3xl sm:text-4xl font-bold text-orange-600 mb-1">2K+</div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-orange-100 text-center shadow-sm">
                ...
                <div className="text-sm text-gray-600">Trained Personnel</div>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-orange-100 text-center shadow-sm">
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-r from-orange-500 via-red-500 to-red-700 relative overflow-hidden">
        ...
        <Container className="relative z-10 text-center">
          ...
          >
            ...
            <p className="text-lg text-orange-100 leading-relaxed mb-8">
              Partner with Slymax Nigeria Limited for complete fire safety solutions. 
              Expert installation, training, and maintenance services.
            </p>
