...
export function CTASection() {
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900" aria-labelledby="cta-heading">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500/10 rounded-full -translate-y-1/3 translate-x-1/3" aria-hidden="true" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Button asChild size="xl" className="gap-2 bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white border-0 shadow-lg shadow-blue-500/25 px-8">
                <Link href="/contact">
                  Get a Free Quote
            ...
            <div className="flex flex-wrap gap-4">
              {guarantees.map((item) => (
                <div key={item.label} className="flex items-center gap-2 text-gray-200 text-sm">
                  <item.icon className="h-4 w-4 text-sky-400" aria-hidden="true" />
                  {item.label}
                </div>
              ))}
            </div>
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/15 flex-shrink-0">
                  <ArrowRight className="h-5 w-5 text-sky-400 rotate-90" aria-hidden="true" />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/15 flex-shrink-0">
                  <Shield className="h-5 w-5 text-sky-400" aria-hidden="true" />
                </div>
                <div>
